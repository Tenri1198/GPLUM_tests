...
#endif
        if ( !fprintf(fp, "%lld\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%20.15e\t%d\t%d\t%20.15e\t%20.15e\t%20.15e\t%d\n",
                      this->id, this->mass, this->r_planet, this->f, 
                      this->pos.x, this->pos.y, this->pos.z,
                      this->vel.x, this->vel.y, this->vel.z,
                      this->neighbor, Flag,
                      this->acc_gd.x,this->acc_gd.y,this->acc_gd.z,this->flag_gd) ) {
            //this->r_out, this->r_search) ){
